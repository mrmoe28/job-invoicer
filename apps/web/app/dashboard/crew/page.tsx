  ...
  const initialCrew: CrewMember[] = [
    {
      ...
      role: 'Foreman',
      phone: '(555) 123-0001',
      email: 'tom.wilson@constructflow.com',
      hourlyRate: '$35.00',
      status: 'Active',
      dateHired: '2023-01-15',
      department: 'Construction',
      skills: 'Leadership, Electrical, Plumbing'
    },
    {
      id: 'crew002',
      name: 'Maria Garcia',
      role: 'Electrician',
      phone: '(555) 123-0002',
      email: 'maria.garcia@constructflow.com',
      hourlyRate: '$28.00',
      status: 'Active',
      dateHired: '2023-03-20',
      department: 'Electrical',
      skills: 'Electrical Systems, Safety, Troubleshooting'
    },
    {
      id: 'crew003',
      name: 'James Brown',
      role: 'Carpenter',
      phone: '(555) 123-0003',
      email: 'james.brown@constructflow.com',
      hourlyRate: '$25.00',
      status: 'Active',
    ...
    },
    {
      ...
      phone: '(555) 123-0004',
      email: 'sandra.lee@constructflow.com',
      hourlyRate: '$32.00',
      status: 'On Leave',
      dateHired: '2022-11-05',
      department: 'Safety',
      skills: 'OSHA Compliance, Risk Assessment, Training'
    }
  ];
              ...
              <div className="flex justify-end space-x-3 mt-6">
                ...
                <button
                  onClick={() => {
                    ...
                    setNewCrew({name:'',role:'',phone:'',email:'',hourlyRate:''});
                  }}
                  className="bg-orange-500 hover:bg-orange-600 text-white px-4 py-2 rounded-lg font-medium transition-colors"
                >
                  Add Crew Member
